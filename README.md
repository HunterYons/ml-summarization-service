Вот готовый код для твоего `README.md`. Я поправил синтаксические ошибки (закрывающие скобки и блоки кода), добавил визуальные акценты, иконки и структурировал всё так, чтобы файл выглядел как серьезный Open Source проект.
